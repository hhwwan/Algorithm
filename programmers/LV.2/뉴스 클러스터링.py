...
def solution(str1, str2):
    ...
    for i in range(len(str1)-1):
        if str1[i:i+2].isalpha():
            str1_ary.append(str1[i:i+2])
    for i in range(len(str2)-1):
        if str2[i:i+2].isalpha():
            str2_ary.append(str2[i:i+2])
            
    # 다중집합 만들기        
    str1_count = Counter(str1_ary)
    str2_count = Counter(str2_ary)
    
    # 교집합, 합집합
    intersection = str1_count & str2_count # 교집합, 각 원소에 대해 min개수
    union = str1_count | str2_count # 합집합, 각 원소에 대해 max개수
